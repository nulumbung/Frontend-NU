...
export default function CreateAgendaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Failed to create agenda: ' + getErrorMessage(error));
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Buat Agenda Baru</h1>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                  placeholder="Contoh: 100 Kursi / Tanpa Batas / 50 VIP + 200 Reguler"
                />
              </div>
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Jika nama penyelenggara sama dengan data Banom, logo otomatis diambil dari Banom.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <label className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-gray-700">
                Tampilkan tombol Daftar Sekarang
              </span>
            </label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="md:col-span-3">
                      ...
                      <input 
                        ...
                        className="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
                        placeholder="Pembukaan & Sambutan"
                      />
                    </div>
