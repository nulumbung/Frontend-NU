...
export interface AgendaData extends AgendaItem { }
...
export function AgendaSection({ initialData }: AgendaSectionProps) {
  const [agendas, setAgendas] = useState<AgendaItem[]>(initialData || []);
